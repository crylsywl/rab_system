...
// Query dasar
$whereClause = "WHERE role='user_rab'";
if ($search !== '') {
...
if (isset($_POST['create'])) {
    ...
    if ($password !== $confirm) {
        ...
        $stmt = $conn->prepare("INSERT INTO users (nama, username, password, role) VALUES (?, ?, ?, 'user_rab')");
...
<body class="bg-white">
  ...
  <div class="">
      <div class="flex items-center justify-between mb-6">
        ...
        <div>
          <h1 class="text-2xl font-semibold text-[#FB8E1B]">User</h1>
          <p class="text-sm text-gray-600">
            List of all Users, create new user and manage existing ones.
          </p>
        </div>
    ...
    <div class="w-full mx-auto bg-white rounded-[20px] p-[40px]">
        ...
        <button id="openModal" class="px-5 py-2 bg-[#023936] w-[148px] cursor-pointer text-white rounded-[10px] inline-flex justify-center items-center gap-2.5">Create User</button>
        </div>
                  ...
                  <tr class="hover:bg-[#E6EBEB]">
                    ...
                    <td class="py-8 px-3">
                      <div class="flex gap-3 items-center">
                        <!-- Tombol Edit -->
                        <a href="detailUser.php?id=<?= $row['id_user'] ?>" 
                          class="flex items-center justify-center hover:bg-blue-100 transition-colors w-8 h-8 duration-150 rounded-xs" title="Edit User">
                        ...
                        <a href="?delete=<?= $row['id_user'] ?>" 
                          ...
                          class="flex items-center justify-center hover:bg-blue-100 transition-colors w-8 h-8 duration-150 rounded-xs" title="Hapus User">
...
<div id="createUserModal"
  ...
  <div id="modalBox"
    ...
    <h2 class="text-2xl font-semibold text-[#FB8E1B] mb-6">Add User</h2>
